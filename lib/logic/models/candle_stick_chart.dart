...
class Chart {
  static List<DropdownMenuItem<String>> interval = [
    DropdownMenuItem(child: Text("1m")),
    DropdownMenuItem(child: Text("2m")),
    DropdownMenuItem(child: Text("5m")),
    DropdownMenuItem(child: Text("15m")),
    DropdownMenuItem(child: Text("30m")),
    DropdownMenuItem(child: Text("60m")),
    DropdownMenuItem(child: Text("90m")),
    DropdownMenuItem(child: Text("1h")),
    DropdownMenuItem(child: Text("1d")),
    DropdownMenuItem(child: Text("5d")),
    DropdownMenuItem(child: Text("1wk")),
    DropdownMenuItem(child: Text("1mo")),
    DropdownMenuItem(child: Text("3mo")),
  ];
  ...
  factory Chart.fromJson(Map<String, dynamic> json) {
    ...
    json = json["chart"]["result"][0] as Map<String, dynamic>;
